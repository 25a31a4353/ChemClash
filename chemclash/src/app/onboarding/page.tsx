    ...
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-56px)]">
      ...
      <div className="flex-1 flex flex-col px-8 sm:px-14 py-10 max-w-2xl">
        ...
        <button
          ...
          className="w-full bg-violet-600 hover:bg-violet-700 disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold text-sm py-3.5 rounded-xl transition-colors"
        >
          Continue →
        </button>

        <div className="mt-10 bg-violet-50 border border-violet-100 rounded-xl px-5 py-4 flex items-start gap-3">
          <span className="text-violet-400 text-xl leading-none mt-0.5">&ldquo;</span>
          <div>
      ...
      <div className="hidden lg:flex flex-col items-center justify-center flex-1 bg-gradient-to-br from-violet-50 via-blue-50 to-white relative overflow-hidden px-12">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {[...Array(6)].map((_, i) => (
            <svg key={i} className="absolute opacity-5"
              style={{ top: `${10 + i * 14}%`, left: `${5 + i * 12}%`, width: 80 }}
              viewBox="0 0 80 80">
    ...
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-56px)]">
      <div className="flex-1 flex flex-col px-8 sm:px-14 py-10 max-w-2xl">
        ...
        <p className="text-sm text-slate-500 leading-relaxed mb-8">
          This helps us tailor questions, resources and recommendations that match your current level.
        </p>
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-56px)]">
      <div className="flex-1 flex flex-col px-8 sm:px-14 py-10 max-w-2xl">
        ...
        <p className="text-sm text-slate-500 leading-relaxed mb-8">
          Choose one or more areas. We&apos;ll personalise your practice,
          content and recommendations based on your goals.
        </p>
      ...
      <div className="hidden lg:flex flex-col items-center justify-center flex-1 bg-gradient-to-br from-violet-50 via-blue-50 to-white relative overflow-hidden px-12">
        <div className="relative flex flex-col items-center gap-0">
          ...
          <div className="flex flex-col gap-1">
            {(["REACT", "PRACTICE", "MASTER"] as const).map((w, i) => (
              <div key={w} className={[
...
export default function OnboardingPage() {
  ...
  // If already onboarded, redirect immediately (avoid re-showing after completion)
  useEffect(() => {
  ...
  function persist(prefs: OnboardingPrefs) {
    ...
    // Write first name into the store so Dashboard welcome message is immediate
  ...
  // Prevent SSR/hydration flash — render nothing until localStorage check done
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Mobile stepper */}
      <div className="sm:hidden flex justify-center py-4 border-b border-slate-100 bg-white">
        <Stepper step={step} />
      </div>
