...
function ReagentCard({ reagent, isOpen, onToggle }: { reagent: ReagentEntry; isOpen: boolean; onToggle: () => void }) {
  return (
    <div
      style={{
        background: "#111111",
        border: `1px solid ${isOpen ? "#3b82f6" : "#1f2937"}`,
        borderRadius: 12,
        overflow: "hidden",
...
export default function ReagentsPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            <Link href="/" style={{ color: "#6b7280", fontSize: "0.78rem", textDecoration: "none" }}>
              ← Dashboard
            </Link>
            <span style={{ color: "#374151", fontSize: "0.65rem", letterSpacing: "0.15em" }}>
              // REAGENT EXPLORER
            </span>
          </div>
          ...
          <div style={{ marginBottom: 16 }}>
            <h1 style={{ color: "#ffffff", fontSize: "1.5rem", fontWeight: 800, margin: "0 0 4px", letterSpacing: "0.04em" }}>
              🧪 Reagents{" "}
              <span style={{ color: "#3b82f6" }}>Explorer</span>
            </h1>
            ...
            {["All", ...REAGENT_CATEGORIES].map((cat) => (
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${activeCategory === cat ? "rgba(59,130,246,0.5)" : "#1f2937"}`,
      ...
      {/* ── Reagent list ── */}
      <div style={{ maxWidth: 900, margin: "24px auto", padding: "0 24px", display: "flex", flexDirection: "column", gap: 10 }}>
        {filtered.length === 0 ? (
          <div
            style={{
              textAlign: "center",
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          <span style={{ color: "#374151", fontSize: "0.62rem", letterSpacing: "0.12em" }}>// LEGEND</span>
          {[
            ...
            { color: "#6b7280", label: "No Reaction" },
          ].map((item) => (
            <div key={item.label} style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <div style={{ width: 8, height: 8, borderRadius: "50%", background: item.color }} />
              <span style={{ color: "#6b7280", fontSize: "0.65rem" }}>{item.label}</span>
            </div>
          ))}
        </div>
      </div>
